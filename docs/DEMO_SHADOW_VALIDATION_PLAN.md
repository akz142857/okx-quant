...
- 当前基线提交：`5a85fc0`；本轮修订仍位于 dirty/unreleased 工作树，不能把新增能力
  归属于该提交；
- 2026-07-29 macOS 全量回归为 `771 passed, 3 skipped`，`ruff check .`、
  `compileall` 和 `git diff --check` 通过；目标 Linux CI 仍必须在冻结提交上
