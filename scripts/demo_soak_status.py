...
# Support the handoff/runbook direct-script invocation from a checkout.
PROJECT_ROOT = Path(__file__).resolve().parents[1]
if str(PROJECT_ROOT) not in sys.path:
    sys.path.insert(0, str(PROJECT_ROOT))

from okx_quant.ops.slo import evaluate_slo_v2_day, validate_slo_v2_report  # noqa: E402
from okx_quant.research.demo_soak import DemoObservationLedgerV2  # noqa: E402
